...
`output_level = "standard"` retains the key fitted trajectories needed to
compare chains without retaining the full diagnostic state. Saving trajectories
costs more memory than the minimal tuning runs, so budget confirmation jobs
accordingly.
